...
! ...OOO..............OOO..T  defined by the true values of a tag array. Afterwards we decide to add for some
! ..OOO................OOO.E  reason more tags. These is useful when different calculation are required with
! .OOO.................OOO.=  different cells.
! .OOO................OOO..=
! .OOO...............@@@...L  Note that we store both neighborhoods in this simple case to proceed with our
! .OOOO.............@...@..O  final computations...                                                          
! ..OOOO..........OOO...@..V
! ....OOOOO...OOOOO....@...I
! .......OOOOOO......@@....N
! ..................@@@@@@.G
program test_neighs2
...
call cpu_time(tstart)
call findneighs(my_neighs,tags=tags,debug=.true.)
...
! the default i.e. lvl_max = 1, see test_neighs6

call cpu_time(tend)
tneighs = tend-tstart

p0=point(-88d-2,0d0,0d0)
n =vector(1d0,0d0,0d0)
allocate(taggys,source=(abs((FVs%pc-p0)*n) <= sqrt(3d0)*FVs%Vc**(1d0/3)/2d0))

taggys_count = count(taggys)

! report the number of cells we work with
print *, my_rank, " Generating Cell Neighborhoods in", taggys_count, "cells"

call cpu_time(tstart)
call findneighs(my_neighs,tags=taggys,debug=.true.)
call cpu_time(tend)
tneighs = tneighs + tend-tstart
