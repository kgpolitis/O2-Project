...
! ..OOO................OOO.E& 
! .OOO.................OOO.=& In this case the neighborhoods are generated everywhere. The level of the 
! .OOO................OOO.=.& neighborhoods is for boundary cells 3 and for every other cell 2. This 
! .OOO...............@@@...L& illustrates the use of the lvl_per_cell optional variable for generating
! .OOOO.............@...@..O& neighborhoods.
! ..OOOO..........OOO...@..V& 
! ....OOOOO...OOOOO....@...I& 
! .......OOOOOO......@@....N& 
! ..................@@@@@@.G  
program test_neighs7
...
implicit none
type(point) :: ps,pe
integer :: nx, ny, nz, i1, nunit, n_elems
...
allocate(lvl_per_cell(size(FVs)),source=2)

do i1=1,size(faces)
    
    if (faces(i1)%bnd) lvl_per_cell(faces(i1)%nb(1)%gl_no)=3
...
call cpu_time(tstart)
call findneighs(my_neighs,lvl_per_cell=lvl_per_cell)!,debug=.true.)
call cpu_time(tend)
