...
implicit none
type(point) :: ps,pe
integer :: nx, ny, nz, i1, nunit,n
class(neighs_opts), allocatable :: my_neighs
real(kind(0.d0)), dimension(:), allocatable :: elem_counts1, elem_counts2, totVs, Vc, distmaxppc!, DGM0, DGM1
real(kind(0.d0)) :: tstart, tend, tgrid, tneighs, tcalc
logical :: mpi_init
logical, dimension(:), allocatable :: DGM_tags
...
call cpu_time(tstart)
call findneighs(my_neighs,dbg=.false.,prf=.true.)
call cpu_time(tend)
tneighs = tend-tstart
