...
% a_d1_p4(3)=1.971434999*a_d1_p2(3)
...
a_T_p4=min([a_T_1_p4 a_T_2_p4 a_T_3_p4 a_T_4_p4],[],2);
...
a_p4_res=[a_t1_p4 a_e1_p4 zeros(5,1) a_d1_p4 a_e2_p4 zeros(5,1) a_d2_p4 a_e3_p4 a_T_p4];
a_p4_mod=[a_t1_p4+a_e1_p4 a_d1_p4+a_e2_p4 a_d2_p4+a_e3_p4 a_t1_p4+a_e1_p4+a_d1_p4+a_e2_p4+a_d2_p4+a_e3_p4 a_cs_p4];
[a_t1n_p4,gof]=fit(a_nwork_p4',a_t1_p4,f,s)
[a_e1n_p4,gof]=fit(a_nwork_p4',a_e1_p4,f,s)
ff = fittype('a*x^1.021','options',ss)
ss=fitoptions('Method','NonlinearLeastSquares','StartPoint',[1])
[a_e2n_p4,gof]=fit(a_nwork_p4',a_e2_p4,ff,ss)
